...
class UserTest < ActionController::IntegrationTest
  ...
  context "An unknown user" do
    ...
    should "register a new company" do
      ...
      assert_response :success
      post "authentication/register", :company=>{:name=>"My Company LTD"}, :user=>{:last_name=>"Company", :first_name=>"My", :name=>"my", :password=>"12345678", :password_confirmation=>"12345678"}
    ...
    should "register a new company with data" do
      get "authentication/register"
      assert_response :success
      post "authentication/register", :company=>{:name=>"My Company LTD"}, :user=>{:last_name=>"Company", :first_name=>"My", :name=>"my", :password=>"12345678", :password_confirmation=>"12345678"}, :demo=>true
      assert_response :redirect
    end
