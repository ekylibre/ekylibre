...
class InterventionDoerTest < ActiveSupport::TestCase
  test_model_actions
  ...
  test 'working duration' do
    intervention_doer = @intervention.doers.first

    assert_equal intervention_doer.working_duration, @intervention.working_duration
    ...
    assert_equal intervention_doer.working_duration, 55.minutes.to_i
    assert_equal intervention_doer.working_duration(nature: :travel), 30.minutes.to_i
    assert_equal intervention_doer.working_duration(nature: :intervention), 25.minutes.to_i
  end
