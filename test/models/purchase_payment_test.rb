...
class PurchasePaymentTest < Ekylibre::Testing::ApplicationTestCase::WithFixtures
  ...
  test 'bookkeeping with discount' do
    ...
    payment = PurchasePayment.create!(mode: mode, payee: payer, amount: 504.12, discount_amount: 12.00, discount_vat: discount_vat, delivered: true, with_discount: true, currency: currency, cash: cash, responsible: responsible, to_bank_at: DateTime.new(2018, 1, 1))
