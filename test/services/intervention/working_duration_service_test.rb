...
module Interventions
  class WorkingDurationServiceTest < ActiveSupport::TestCase
    setup do
      @now = Time.zone.now
    ...
    test 'return sum of specified nature working periods for worker' do
      ...
      intervention_duration = Interventions::WorkingDurationService
                                .new(working_params)
                                .perform(nature: :intervention)
      ...
      travel_duration = Interventions::WorkingDurationService
                         .new(working_params)
