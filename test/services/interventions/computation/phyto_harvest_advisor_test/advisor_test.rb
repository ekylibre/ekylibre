...
module Interventions
  module Computation
    module PhytoHarvestAdvisorTest
      class AdvisorTest < Ekylibre::Testing::ApplicationTestCase::WithFixtures
        setup do
          @harvest_period = PhytoHarvestAdvisor::Period.new("2013-09-16T05:00:25+00:00", "2013-09-16T17:00:25+00:00")
        ...
        test 'compute result not possible' do
          ...
          pulve_periods = periods.map { |start_date, end_date| PhytoHarvestAdvisor::Period.new(start_date, end_date) }
          results = PhytoHarvestAdvisor.new.compute_result(@harvest_period, pulve_periods)

          assert_not results.possible
          assert_equal "2013-09-16T17:30:25+00:00", results.next_possible_date
        end
        ...
        test 'reentry possible from interventions?' do
          harvest_period = PhytoHarvestAdvisor::Period.new("2020-02-26T14:05:25+00:00", "2020-02-26T17:00:25+00:00")

          reentry_delay = PhytoHarvestAdvisor.new.reentry_possible_from_interventions?(harvest_period, [@spraying_intervention])

          assert_equal "2020-02-26T20:00:25+00:00".to_datetime, reentry_delay.next_possible_date
        ...
        test 'harvest not possible from interventions' do
          ...
          assert_equal "2020-02-29T14:00:25+00:00".to_datetime, pre_harvest_delay.next_possible_date
          assert_not pre_harvest_delay.possible
        end

        test 'harvest possible from interventions' do
          harvest_period = PhytoHarvestAdvisor::Period.new("2020-02-29T14:05:25+00:00", "2020-02-29T17:00:25+00:00")
