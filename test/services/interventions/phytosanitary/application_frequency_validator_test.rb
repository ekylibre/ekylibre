  ...
  module Phytosanitary
    class ApplicationFrequencyValidatorTest < Ekylibre::Testing::ApplicationTestCase
      test "if no targets, all products should be marked as unknown" do
        ...
        product = Product.new
        product_usages = [Models::ProductWithUsage.new(product, RegisteredPhytosanitaryUsage.new, 0, "")]
      ...
      test "guess_vote" do
        ...
        cases.each do |usage_params, maaid, phyto, interval_respected, expected|
          ...
          product_usage = Models::ProductWithUsage.new(product, usage, 0, "")
      ...
      private
        ...
        def make_usage(applications_frequency: nil)
          {
