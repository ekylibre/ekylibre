...
module Backend
  module Visualizations
    class EconomicMapCellsVisualizationsControllerTest < Ekylibre::Testing::ApplicationControllerTestCase::WithFixtures
      setup do
      ...
      test 'async loading economic map cells visualization' do
        productions = ActivityProduction.of_campaign(@user.current_campaign)
        expected_productions_count = productions.count

        get :show, params: { campaigns: @user.current_campaign, format: :json }, xhr: true
