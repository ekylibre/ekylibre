  ...
  module Schema
    ...
    TABLES = {
      ...
      entity_addresses: {
        ...
        mail_postal_zone_id: Column.new(:mail_postal_zone_id,   :integer, references: :postal_zone).freeze,
      ...
      financial_asset_depreciations: {
        ...
        created_on:         Column.new(:created_on,              :date, null: false).freeze,
        creator_id:         Column.new(:creator_id,           :integer, references: :user).freeze,
        depreciable_amount: Column.new(:depreciable_amount,   :decimal, precision: 19, scale: 4).freeze,
        depreciated_amount: Column.new(:depreciated_amount,   :decimal, precision: 19, scale: 4).freeze,
        financial_asset_id: Column.new(:financial_asset_id,   :integer, references: :financial_asset, null: false).freeze,
      ...
      postal_zones: {
        ...
        lock_version: Column.new(:lock_version,   :integer, null: false, default: 0).freeze,
        name:         Column.new(:name,            :string, null: false).freeze,
        postal_code:  Column.new(:postal_code,     :string, null: false).freeze,
        updated_at:   Column.new(:updated_at,    :datetime, null: false).freeze,
        updater_id:   Column.new(:updater_id,     :integer, references: :user).freeze
      }.with_indifferent_access.freeze,
      preferences: {
      ...
      product_nature_categories: {
        ...
        description:                Column.new(:description,                     :text).freeze,
        financial_asset_account_id: Column.new(:financial_asset_account_id,   :integer, references: :account).freeze,
        id:                         Column.new(:id,                           :integer, null: false).freeze,
        lock_version:               Column.new(:lock_version,                 :integer, null: false, default: 0).freeze,
        name:                       Column.new(:name,                          :string, null: false).freeze,
      ...
      products: {
        ...
        financial_asset_id:       Column.new(:financial_asset_id,         :integer, references: :financial_asset).freeze,
        id:                       Column.new(:id,                         :integer, null: false).freeze,
