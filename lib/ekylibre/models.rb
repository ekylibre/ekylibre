...
module Ekylibre
  ...
  SCHEMA = HashWithIndifferentAccess.new(
    ...
    areas: HashWithIndifferentAccess.new(
      ...
      country: Ekylibre::Record::Column.new(:country, :string, limit: 2, default: "??").freeze,
      created_at: Ekylibre::Record::Column.new(:created_at, :datetime, null: false).freeze,
      creator_id: Ekylibre::Record::Column.new(:creator_id, :integer).freeze,
    ...
    asset_depreciations: HashWithIndifferentAccess.new(
      ...
      protected: Ekylibre::Record::Column.new(:protected, :boolean, null: false).freeze,
    ...
    document_archives: HashWithIndifferentAccess.new(
      archived_at: Ekylibre::Record::Column.new(:archived_at, :datetime).freeze,
      created_at: Ekylibre::Record::Column.new(:created_at, :datetime, null: false).freeze,
      creator_id: Ekylibre::Record::Column.new(:creator_id, :integer).freeze,
    ...
    entities: HashWithIndifferentAccess.new(
      ...
      language: Ekylibre::Record::Column.new(:language, :string, limit: 3, null: false, default: "???").freeze,
    ...
    events: HashWithIndifferentAccess.new(
      ...
      id: Ekylibre::Record::Column.new(:id, :integer, null: false).freeze,
      lock_version: Ekylibre::Record::Column.new(:lock_version, :integer, null: false, default: 0).freeze,
      meeting_nature_id: Ekylibre::Record::Column.new(:meeting_nature_id, :integer).freeze,
      name: Ekylibre::Record::Column.new(:name, :text).freeze,
      place: Ekylibre::Record::Column.new(:place, :string).freeze,
      procedure_id: Ekylibre::Record::Column.new(:procedure_id, :integer).freeze,
    ...
    inventories: HashWithIndifferentAccess.new(
      accounted_at: Ekylibre::Record::Column.new(:accounted_at, :datetime).freeze,
      changes_reflected: Ekylibre::Record::Column.new(:changes_reflected, :boolean).freeze,
      created_at: Ekylibre::Record::Column.new(:created_at, :datetime, null: false).freeze,
      created_on: Ekylibre::Record::Column.new(:created_on, :date, null: false).freeze,
      creator_id: Ekylibre::Record::Column.new(:creator_id, :integer).freeze,
      description: Ekylibre::Record::Column.new(:description, :text).freeze,
    ...
    logs: HashWithIndifferentAccess.new(
      ...
      owner_type: Ekylibre::Record::Column.new(:owner_type, :string).freeze,
      updated_at: Ekylibre::Record::Column.new(:updated_at, :datetime, null: false).freeze,
      updater_id: Ekylibre::Record::Column.new(:updater_id, :integer).freeze
    ).freeze,
    ...
    meeting_participations: HashWithIndifferentAccess.new(
      ...
      id: Ekylibre::Record::Column.new(:id, :integer, null: false).freeze,
      lock_version: Ekylibre::Record::Column.new(:lock_version, :integer, null: false, default: 0).freeze,
      meeting_id: Ekylibre::Record::Column.new(:meeting_id, :integer, null: false).freeze,
    ...
    operation_tasks: HashWithIndifferentAccess.new(
      ...
      operand_unit: Ekylibre::Record::Column.new(:operand_unit, :string).freeze,
    ...
    preferences: HashWithIndifferentAccess.new(
      ...
      lock_version: Ekylibre::Record::Column.new(:lock_version, :integer, null: false, default: 0).freeze,
      name: Ekylibre::Record::Column.new(:name, :string, null: false).freeze,
      nature: Ekylibre::Record::Column.new(:nature, :string, limit: 8, null: false, default: "u").freeze,
    ...
    procedure_variables: HashWithIndifferentAccess.new(
      ...
      lock_version: Ekylibre::Record::Column.new(:lock_version, :integer, null: false, default: 0).freeze,
      measure_quantity: Ekylibre::Record::Column.new(:measure_quantity, :decimal, precision: 19, scale: 4, null: false).freeze,
      measure_unit: Ekylibre::Record::Column.new(:measure_unit, :string, null: false).freeze,
      procedure_id: Ekylibre::Record::Column.new(:procedure_id, :integer, null: false).freeze,
      role: Ekylibre::Record::Column.new(:role, :string, null: false).freeze,
      target_id: Ekylibre::Record::Column.new(:target_id, :integer, null: false).freeze,
      updated_at: Ekylibre::Record::Column.new(:updated_at, :datetime, null: false).freeze,
      updater_id: Ekylibre::Record::Column.new(:updater_id, :integer).freeze
    ).freeze,
    procedures: HashWithIndifferentAccess.new(
      ...
      nomen: Ekylibre::Record::Column.new(:nomen, :string, null: false).freeze,
      ...
      provisional_procedure_id: Ekylibre::Record::Column.new(:provisional_procedure_id, :integer).freeze,
      state: Ekylibre::Record::Column.new(:state, :string, null: false, default: "undone").freeze,
      updated_at: Ekylibre::Record::Column.new(:updated_at, :datetime, null: false).freeze,
      updater_id: Ekylibre::Record::Column.new(:updater_id, :integer).freeze
    ).freeze,
    ...
    sale_items: HashWithIndifferentAccess.new(
      ...
      created_at: Ekylibre::Record::Column.new(:created_at, :datetime, null: false).freeze,
      creator_id: Ekylibre::Record::Column.new(:creator_id, :integer).freeze,
      entity_id: Ekylibre::Record::Column.new(:entity_id, :integer).freeze,
      id: Ekylibre::Record::Column.new(:id, :integer, null: false).freeze,
    ...
    sale_natures: HashWithIndifferentAccess.new(
      ...
      downpayment_minimum: Ekylibre::Record::Column.new(:downpayment_minimum, :decimal, precision: 19, scale: 4, null: false, default: 0.0).freeze,
      downpayment_percentage: Ekylibre::Record::Column.new(:downpayment_percentage, :decimal, precision: 19, scale: 4, null: false, default: 0.0).freeze,
    ...
    sales: HashWithIndifferentAccess.new(
      ...
      sum_method: Ekylibre::Record::Column.new(:sum_method, :string, limit: 8, null: false, default: "wt").freeze,
      transporter_id: Ekylibre::Record::Column.new(:transporter_id, :integer).freeze,
      updated_at: Ekylibre::Record::Column.new(:updated_at, :datetime, null: false).freeze,
      updater_id: Ekylibre::Record::Column.new(:updater_id, :integer).freeze
    ).freeze,
    ...
    sessions: HashWithIndifferentAccess.new(
      data: Ekylibre::Record::Column.new(:data, :text).freeze,
      id: Ekylibre::Record::Column.new(:id, :integer, null: false).freeze,
      session_id: Ekylibre::Record::Column.new(:session_id, :string).freeze,
      updated_at: Ekylibre::Record::Column.new(:updated_at, :datetime).freeze
    ).freeze,
    ...
    taxes: HashWithIndifferentAccess.new(
      amount: Ekylibre::Record::Column.new(:amount, :decimal, precision: 19, scale: 4, null: false, default: 0.0).freeze,
      collected_account_id: Ekylibre::Record::Column.new(:collected_account_id, :integer).freeze,
      created_at: Ekylibre::Record::Column.new(:created_at, :datetime, null: false).freeze,
      creator_id: Ekylibre::Record::Column.new(:creator_id, :integer).freeze,
      description: Ekylibre::Record::Column.new(:description, :text).freeze,
      id: Ekylibre::Record::Column.new(:id, :integer, null: false).freeze,
      ...
      name: Ekylibre::Record::Column.new(:name, :string, null: false).freeze,
      nature: Ekylibre::Record::Column.new(:nature, :string, limit: 16, null: false).freeze,
      paid_account_id: Ekylibre::Record::Column.new(:paid_account_id, :integer).freeze,
