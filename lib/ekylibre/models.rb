...
module Ekylibre
  ...
  @@references = {
    ...
    :animal => {
      ...
      :father_id => :product,
      :initial_container_id => :product,
      :initial_owner_id => :entity,
      :mother_id => :product,
    ...
    :inventory_item => {
      ...
      :product_id => :product,
      :product_measurement_id => :product_measurement,
      :updater_id => :user
    },
    :journal => {
      :creator_id => :user,
  ...
  SCHEMA = HashWithIndifferentAccess.new(
    ...
    cash_transfers: HashWithIndifferentAccess.new(
      ...
      created_at: Ekylibre::Record::Column.new(:created_at, :datetime, null: false).freeze,
      creator_id: Ekylibre::Record::Column.new(:creator_id, :integer).freeze,
      currency_rate: Ekylibre::Record::Column.new(:currency_rate, :decimal, precision: 19, scale: 10, null: false).freeze,
      description: Ekylibre::Record::Column.new(:description, :text).freeze,
      emission_amount: Ekylibre::Record::Column.new(:emission_amount, :decimal, precision: 19, scale: 4, null: false).freeze,
      ...
      lock_version: Ekylibre::Record::Column.new(:lock_version, :integer, null: false, default: 0).freeze,
      number: Ekylibre::Record::Column.new(:number, :string, null: false).freeze,
      reception_amount: Ekylibre::Record::Column.new(:reception_amount, :decimal, precision: 19, scale: 4, null: false).freeze,
      ...
      transfered_on: Ekylibre::Record::Column.new(:transfered_on, :date, null: false).freeze,
      updated_at: Ekylibre::Record::Column.new(:updated_at, :datetime, null: false).freeze,
      updater_id: Ekylibre::Record::Column.new(:updater_id, :integer).freeze
    ).freeze,
    ...
    catalog_prices: HashWithIndifferentAccess.new(
      ...
      currency: Ekylibre::Record::Column.new(:currency, :string, limit: 3, null: false).freeze,
      id: Ekylibre::Record::Column.new(:id, :integer, null: false).freeze,
      indicator_name: Ekylibre::Record::Column.new(:indicator_name, :string, limit: 120, null: false).freeze,
      lock_version: Ekylibre::Record::Column.new(:lock_version, :integer, null: false, default: 0).freeze,
      name: Ekylibre::Record::Column.new(:name, :string, null: false).freeze,
    ...
    custom_fields: HashWithIndifferentAccess.new(
      ...
      column_name: Ekylibre::Record::Column.new(:column_name, :string, null: false).freeze,
      created_at: Ekylibre::Record::Column.new(:created_at, :datetime, null: false).freeze,
      creator_id: Ekylibre::Record::Column.new(:creator_id, :integer).freeze,
    ...
    entity_links: HashWithIndifferentAccess.new(
      ...
      entity_1_role: Ekylibre::Record::Column.new(:entity_1_role, :string, null: false).freeze,
      entity_2_id: Ekylibre::Record::Column.new(:entity_2_id, :integer, null: false).freeze,
      entity_2_role: Ekylibre::Record::Column.new(:entity_2_role, :string, null: false).freeze,
      id: Ekylibre::Record::Column.new(:id, :integer, null: false).freeze,
      lock_version: Ekylibre::Record::Column.new(:lock_version, :integer, null: false, default: 0).freeze,
      nature: Ekylibre::Record::Column.new(:nature, :string, null: false).freeze,
      started_at: Ekylibre::Record::Column.new(:started_at, :datetime).freeze,
    ...
    events: HashWithIndifferentAccess.new(
      ...
      restricted: Ekylibre::Record::Column.new(:restricted, :boolean, null: false).freeze,
    ...
    intervention_casts: HashWithIndifferentAccess.new(
      ...
      lock_version: Ekylibre::Record::Column.new(:lock_version, :integer, null: false, default: 0).freeze,
      population: Ekylibre::Record::Column.new(:population, :decimal, precision: 19, scale: 4).freeze,
      ...
      shape: Ekylibre::Record::Column.new(:shape, :spatial).freeze,
      updated_at: Ekylibre::Record::Column.new(:updated_at, :datetime, null: false).freeze,
      updater_id: Ekylibre::Record::Column.new(:updater_id, :integer).freeze,
    ...
    inventory_items: HashWithIndifferentAccess.new(
      ...
      lock_version: Ekylibre::Record::Column.new(:lock_version, :integer, null: false, default: 0).freeze,
      population: Ekylibre::Record::Column.new(:population, :decimal, precision: 19, scale: 4, null: false).freeze,
      product_id: Ekylibre::Record::Column.new(:product_id, :integer, null: false).freeze,
      product_measurement_id: Ekylibre::Record::Column.new(:product_measurement_id, :integer).freeze,
      theoric_population: Ekylibre::Record::Column.new(:theoric_population, :decimal, precision: 19, scale: 4, null: false).freeze,
      updated_at: Ekylibre::Record::Column.new(:updated_at, :datetime, null: false).freeze,
      updater_id: Ekylibre::Record::Column.new(:updater_id, :integer).freeze
    ).freeze,
    ...
    outgoing_deliveries: HashWithIndifferentAccess.new(
      address_id: Ekylibre::Record::Column.new(:address_id, :integer, null: false).freeze,
      created_at: Ekylibre::Record::Column.new(:created_at, :datetime, null: false).freeze,
      creator_id: Ekylibre::Record::Column.new(:creator_id, :integer).freeze,
      id: Ekylibre::Record::Column.new(:id, :integer, null: false).freeze,
      lock_version: Ekylibre::Record::Column.new(:lock_version, :integer, null: false, default: 0).freeze,
    ...
    outgoing_delivery_items: HashWithIndifferentAccess.new(
      ...
      product_id: Ekylibre::Record::Column.new(:product_id, :integer, null: false).freeze,
      sale_item_id: Ekylibre::Record::Column.new(:sale_item_id, :integer).freeze,
      source_product_id: Ekylibre::Record::Column.new(:source_product_id, :integer, null: false).freeze,
      updated_at: Ekylibre::Record::Column.new(:updated_at, :datetime, null: false).freeze,
      updater_id: Ekylibre::Record::Column.new(:updater_id, :integer).freeze
    ).freeze,
    ...
    prescriptions: HashWithIndifferentAccess.new(
      created_at: Ekylibre::Record::Column.new(:created_at, :datetime, null: false).freeze,
      creator_id: Ekylibre::Record::Column.new(:creator_id, :integer).freeze,
      delivered_at: Ekylibre::Record::Column.new(:delivered_at, :datetime).freeze,
      description: Ekylibre::Record::Column.new(:description, :text).freeze,
    ...
    product_births: HashWithIndifferentAccess.new(
      created_at: Ekylibre::Record::Column.new(:created_at, :datetime, null: false).freeze,
      creator_id: Ekylibre::Record::Column.new(:creator_id, :integer).freeze,
      id: Ekylibre::Record::Column.new(:id, :integer, null: false).freeze,
      lock_version: Ekylibre::Record::Column.new(:lock_version, :integer, null: false, default: 0).freeze,
    ...
    product_enjoyments: HashWithIndifferentAccess.new(
      created_at: Ekylibre::Record::Column.new(:created_at, :datetime, null: false).freeze,
      creator_id: Ekylibre::Record::Column.new(:creator_id, :integer).freeze,
      enjoyer_id: Ekylibre::Record::Column.new(:enjoyer_id, :integer).freeze,
      id: Ekylibre::Record::Column.new(:id, :integer, null: false).freeze,
      lock_version: Ekylibre::Record::Column.new(:lock_version, :integer, null: false, default: 0).freeze,
      nature: Ekylibre::Record::Column.new(:nature, :string, null: false).freeze,
      operation_id: Ekylibre::Record::Column.new(:operation_id, :integer).freeze,
    ...
    product_linkages: HashWithIndifferentAccess.new(
      carried_id: Ekylibre::Record::Column.new(:carried_id, :integer).freeze,
    ...
    product_measurements: HashWithIndifferentAccess.new(
      created_at: Ekylibre::Record::Column.new(:created_at, :datetime, null: false).freeze,
      creator_id: Ekylibre::Record::Column.new(:creator_id, :integer).freeze,
      id: Ekylibre::Record::Column.new(:id, :integer, null: false).freeze,
      indicator_name: Ekylibre::Record::Column.new(:indicator_name, :string, null: false).freeze,
    ...
    product_natures: HashWithIndifferentAccess.new(
      abilities_list: Ekylibre::Record::Column.new(:abilities_list, :text).freeze,
      active: Ekylibre::Record::Column.new(:active, :boolean, null: false).freeze,
      category_id: Ekylibre::Record::Column.new(:category_id, :integer, null: false).freeze,
      created_at: Ekylibre::Record::Column.new(:created_at, :datetime, null: false).freeze,
      creator_id: Ekylibre::Record::Column.new(:creator_id, :integer).freeze,
      ...
      frozen_indicators_list: Ekylibre::Record::Column.new(:frozen_indicators_list, :text).freeze,
      id: Ekylibre::Record::Column.new(:id, :integer, null: false).freeze,
      linkage_points_list: Ekylibre::Record::Column.new(:linkage_points_list, :text).freeze,
      lock_version: Ekylibre::Record::Column.new(:lock_version, :integer, null: false, default: 0).freeze,
      name: Ekylibre::Record::Column.new(:name, :string, null: false).freeze,
      number: Ekylibre::Record::Column.new(:number, :string, limit: 30, null: false).freeze,
      picture_content_type: Ekylibre::Record::Column.new(:picture_content_type, :string).freeze,
      ...
      updated_at: Ekylibre::Record::Column.new(:updated_at, :datetime, null: false).freeze,
      updater_id: Ekylibre::Record::Column.new(:updater_id, :integer).freeze,
      variable_indicators_list: Ekylibre::Record::Column.new(:variable_indicators_list, :text).freeze,
      variety: Ekylibre::Record::Column.new(:variety, :string, limit: 120, null: false).freeze
    ).freeze,
    ...
    products: HashWithIndifferentAccess.new(
      ...
      category_id: Ekylibre::Record::Column.new(:category_id, :integer, null: false).freeze,
      content_indicator_name: Ekylibre::Record::Column.new(:content_indicator_name, :string).freeze,
      ...
      initial_arrival_cause: Ekylibre::Record::Column.new(:initial_arrival_cause, :string, limit: 120).freeze,
      initial_container_id: Ekylibre::Record::Column.new(:initial_container_id, :integer).freeze,
      initial_owner_id: Ekylibre::Record::Column.new(:initial_owner_id, :integer).freeze,
      initial_population: Ekylibre::Record::Column.new(:initial_population, :decimal, precision: 19, scale: 4, default: 0.0).freeze,
      lock_version: Ekylibre::Record::Column.new(:lock_version, :integer, null: false, default: 0).freeze,
    ...
    users: HashWithIndifferentAccess.new(
      ...
      team_id: Ekylibre::Record::Column.new(:team_id, :integer).freeze,
