...
module Ekylibre
  ...
  @@references = {
    ...
    :activity => {
      :area_unit_id => :unit,
      :creator_id => :user,
      :favored_product_nature_id => :product_nature,
      :parent_id => :activity,
      :updater_id => :user,
      :work_unit_id => :unit
    },
