      ...
      class Generator
        ...
        def mammalia_birth_conditions
          ...
          if File.exist?(xsd_url)
            ...
            results += "**Matched Nomen Mammalia birth conditions items: #{nomen_mammalia_birth_conditions.select{|_,v| v[:matched]==1}.size}/#{nomen_mammalia_birth_conditions.size} (#{out_existing_exception.size} manually)\n"

            results += "**#{nomen_mammalia_birth_conditions.select{|_,v| v[:matched]==0}.size} Missing Nomen Item Matching: \n"
            ...
            results += "**Matched Idele mammalia_birth_conditions: #{idele_mammalia_birth_conditions.select{|_,v| v[:matched]==1}.size}/#{idele_mammalia_birth_conditions.size} (#{in_existing_exception.size} manually)\n"

            results += "**#{idele_mammalia_birth_conditions.select{|_,v| v[:matched]==0}.size} Missing Idele mammalia_birth_conditions Matching: \n"
        ...
        def entry_reason
          ...
          if File.exist?(xsd_url)
            ...
            results += "**Matched Nomen Entry Reason items: #{nomen_entry_reason.select{|_,v| v[:matched]==1}.size}/#{nomen_entry_reason.size} (#{out_existing_exception.size} manually)\n"

            results += "**#{nomen_entry_reason.select{|_,v| v[:matched]==0}.size} Missing Nomen Item Matching: \n"
            ...
            results += "**Matched Idele entry_reason: #{idele_entry_reason.select{|_,v| v[:matched]==1}.size}/#{idele_entry_reason.size} (#{in_existing_exception.size} manually)\n"

            results += "**#{idele_entry_reason.select{|_,v| v[:matched]==0}.size} Missing Idele entry_reason Matching: \n"
        ...
        def exit_reason
          ...
          if File.exist?(xsd_url)
            ...
            results += "**Matched Nomen Exit Reason items: #{nomen_exit_reason.select{|_,v| v[:matched]==1}.size}/#{nomen_exit_reason.size} (#{out_existing_exception.size} manually)\n"

            results += "**#{nomen_exit_reason.select{|_,v| v[:matched]==0}.size} Missing Nomen Item Matching: \n"
            ...
            results += "**Matched Idele exit_reason: #{idele_exit_reason.select{|_,v| v[:matched]==1}.size}/#{idele_exit_reason.size} (#{in_existing_exception.size} manually)\n"

            results += "**#{idele_exit_reason.select{|_,v| v[:matched]==0}.size} Missing Idele exit_reason Matching: \n"
        ...
        def temoin_completude
          ...
          if File.exist?(xsd_url)
            ...
            results += "**Matched Nomen Temoin completude items: #{nomen_temoin_completude.select{|_,v| v[:matched]==1}.size}/#{nomen_temoin_completude.size} (#{out_existing_exception.size} manually)\n"

            results += "**#{nomen_temoin_completude.select{|_,v| v[:matched]==0}.size} Missing Nomen Item Matching: \n"
            ...
            results += "**Matched Idele temoin_completude: #{idele_temoin_completude.select{|_,v| v[:matched]==1}.size}/#{idele_temoin_completude.size} (#{in_existing_exception.size} manually)\n"

            results += "**#{idele_temoin_completude.select{|_,v| v[:matched]==0}.size} Missing Idele temoin_completude Matching: \n"
        ...
        def temoin_fin_de_vie
          ...
          if File.exist?(xsd_url)
            ...
            results += "**Matched Nomen Temoin fin_de_vie items: #{nomen_temoin_fin_de_vie.select{|_,v| v[:matched]==1}.size}/#{nomen_temoin_fin_de_vie.size} (#{out_existing_exception.size} manually)\n"

            results += "**#{nomen_temoin_fin_de_vie.select{|_,v| v[:matched]==0}.size} Missing Nomen Item Matching: \n"
            ...
            results += "**Matched Idele temoin_fin_de_vie: #{idele_temoin_fin_de_vie.select{|_,v| v[:matched]==1}.size}/#{idele_temoin_fin_de_vie.size} (#{in_existing_exception.size} manually)\n"

            results += "**#{idele_temoin_fin_de_vie.select{|_,v| v[:matched]==0}.size} Missing Idele temoin_fin_de_vie Matching: \n"
        ...
        def cause_remplacement
          ...
          if File.exist?(xsd_url)
            ...
            results += "**Matched Nomen cause remplacement items: #{nomen_cause_remplacement.select{|_,v| v[:matched]==1}.size}/#{nomen_cause_remplacement.size} (#{out_existing_exception.size} manually)\n"

            results += "**#{nomen_cause_remplacement.select{|_,v| v[:matched]==0}.size} Missing Nomen Item Matching: \n"
            ...
            results += "**Matched Idele cause_remplacement: #{idele_cause_remplacement.select{|_,v| v[:matched]==1}.size}/#{idele_cause_remplacement.size} (#{in_existing_exception.size} manually)\n"

            results += "**#{idele_cause_remplacement.select{|_,v| v[:matched]==0}.size} Missing Idele cause_remplacement Matching: \n"
        ...
        def mode_insemination
          ...
          if File.exist?(xsd_url)
            ...
            results += "**Matched Nomen mode insemination items: #{nomen_mode_insemination.select{|_,v| v[:matched]==1}.size}/#{nomen_mode_insemination.size} (#{out_existing_exception.size} manually)\n"

            results += "**#{nomen_mode_insemination.select{|_,v| v[:matched]==0}.size} Missing Nomen Item Matching: \n"
            ...
            results += "**Matched Idele mode_insemination: #{idele_mode_insemination.select{|_,v| v[:matched]==1}.size}/#{idele_mode_insemination.size} (#{in_existing_exception.size} manually)\n"

            results += "**#{idele_mode_insemination.select{|_,v| v[:matched]==0}.size} Missing Idele mode_insemination Matching: \n"
