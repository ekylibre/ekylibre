module Ekylibre
  module Record
    ...
    module ConditionalReadonlyAttributes
    ...
    module HumanForeignKeyName
      def human_attribute_name(attribute, options = {})
        super(attribute.to_s.gsub(/_id\z/, ''), options)
      end
    end    
    
    # Permits to register scope and list them after loading
    module ScopeRegistration
    ...
    class Base < ActiveRecord::Base
      ...
      class << self
        ...
        prepend ScopeRegistration
        prepend HumanForeignKeyName
        prepend ConditionalReadonlyAttributes
