module ActiveExchanger
  class Base
    ...
    VENDORS = %i[agro_systemes agroedi bordeaux_sciences_agro bovins_croissance caj charentes_alliance ebp ekylibre fiea isagri lely_milk_robot lilco logicall milklic none odicom socleo quadra sage square synel synest telepac upra vivescia].freeze
