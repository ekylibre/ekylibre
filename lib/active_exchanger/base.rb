module ActiveExchanger
  class Base
    ...
    VENDORS = %i[agro_systemes agrigest agroedi bordeaux_sciences_agro bovins_croissance caj charentes_alliance ebp ekylibre fiea isagri lely_milk_robot lilco listo logicall milklic none odicom planete_vegetal process_to_wine socleo quadra sage square synel synest telepac upra vivescia].freeze
