...
# List of all models
EKYLIBRE_MODELS = [:account, :account_balance, :area, :bank_account, :bank_account_statement, :company, :complement, :complement_choice, :complement_datum, :contact, :currency, :delay, :delivery, :delivery_line, :delivery_mode, :department, :district, :document, :document_template, :embankment, :entity, :entity_category, :entity_link, :entity_link_nature, :entity_nature, :entry, :establishment, :event, :event_nature, :financialyear, :inventory, :inventory_line, :invoice, :invoice_line, :journal, :journal_record, :language, :listing, :listing_node, :listing_node_item, :mandate, :observation, :operation, :operation_line, :operation_nature, :parameter, :payment, :payment_mode, :payment_part, :price, :price_tax, :product, :product_component, :production, :profession, :purchase_order, :purchase_order_line, :role, :sale_order, :sale_order_line, :sale_order_nature, :sequence, :shape, :shelf, :stock, :stock_location, :stock_move, :stock_transfer, :subscription, :subscription_nature, :tax, :tax_declaration, :tool, :tool_use, :tracking, :transfer, :transport, :unit, :user]
...
EKYLIBRE_REFERENCES = {
  ...
  :stock_move => {
    ...
    :origin_id => "origin_type",
    :product_id => :product,
    :second_location_id => :stock_location,
