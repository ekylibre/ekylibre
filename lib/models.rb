...
EKYLIBRE_REFERENCES = {
  ...
  :shape_operation => {
    ...
    :creator_id => :user,
    :employee_id => :employee,
    :nature_id => :shape_operation_nature,
    :shape_id => :shape,
    :updater_id => :user
  },
  :shape_operation_line => {
    :area_unit_id => :unit,
    :company_id => :company,
    :creator_id => :user,
    :product_id => :product,
    :product_unit_id => :unit,
    :shape_operation_id => :shape_operation,
    :tracking_id => :stock_tracking,
    :updater_id => :user
  },
  :shape_operation_nature => {
    :company_id => :company,
    :creator_id => :user,
    :updater_id => :user
  },
