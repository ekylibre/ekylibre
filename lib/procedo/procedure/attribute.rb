module Procedo
  class Procedure
    ...
    class Attribute < Procedo::Procedure::Setter
      TYPES = %i[new_name working_zone new_container new_group new_variant killable identification_number usage_id allowed_entry_factor allowed_harvest_factor spray_volume_value].freeze
