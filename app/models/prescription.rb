...
#  prescriptor_id   :integer(4)       not null
...
class Prescription < ApplicationRecord
  ...
  validates :delivered_at, timeliness: { on_or_after: -> { Time.new(1, 1, 1).in_time_zone }, on_or_before: -> { Time.zone.now + 100.years } }, allow_blank: true
