...
class Cash < Ekylibre::Record::Base
  ...
  validates_length_of :bank_account_key, :bank_account_number, :bank_agency_code, :bank_code, :bank_identifier_code, :bank_name, :country, :currency, :iban, :mode, :name, :nature, :spaced_iban, allow_nil: true, maximum: 255
