...
class CustomField < Ekylibre::Record::Base
  ...
  enumerize :customized_type, in: (Ekylibre::Schema.model_names - [:AccountBalance, :ActivityDistribution, :AnalysisItem, :Affair, :CashSession, :Crumb, :CultivableZoneMembership, :CustomField, :CustomFieldChoice, :DocumentArchive, :EntityAddress, :FixedAssetDepreciation, :Gap, :GapItem, :GuideAnalysis, :GuideAnalysisPoint, :IncomingParcelItem, :InterventionCast, :InventoryItem, :JournalEntryItem, :ListingNode, :ListingNodeItem, :ManureManagementPlan, :ManureManagementPlanZone, :Observation, :Operation, :OutgoingParcelItem, :Preference, :ProductEnjoyment, :ProductionBudget, :ProductionDistribution, :ProductJunction, :ProductJunctionWay, :ProductLink, :ProductLinkage, :ProductLocalization, :ProductMembership, :ProductNatureCategoryTaxation, :ProductNatureVariantReading, :ProductOwnership, :ProductPhase, :ProductReading, :ProductReadingTask, :PurchaseItem, :SaleItem, :User, :Version])
