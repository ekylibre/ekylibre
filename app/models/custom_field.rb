...
class CustomField < Ekylibre::Record::Base
  ...
  enumerize :customized_type, in: (Ekylibre::Schema.model_names - [:AccountBalance, :ActivityDistribution, :AnalysisItem, :Affair, :CashSession, :Crumb, :CultivableZoneMembership, :CustomField, :CustomFieldChoice, :DocumentArchive, :EntityAddress, :FinancialAssetDepreciation, :Gap, :GapItem, :GuideAnalysis, :GuideAnalysisPoint, :IncomingDeliveryItem, :InterventionCast, :InventoryItem, :JournalEntryItem, :ListingNode, :ListingNodeItem, :ManureManagementPlan, :ManureManagementPlanZone, :Observation, :Operation, :OutgoingDeliveryItem, :Preference, :ProductBirth, :ProductConsumption, :ProductCreation, :ProductDeath, :ProductDivision, :ProductEnjoyment, :ProductionBudget, :ProductionDistribution, :ProductJunction, :ProductJunctionWay, :ProductLink, :ProductLinkage, :ProductLocalization, :ProductMembership, :ProductMerging, :ProductMixing, :ProductNatureCategoryTaxation, :ProductNatureVariantReading, :ProductOwnership, :ProductPhase, :ProductQuadrupleMixing, :ProductQuintupleMixing, :ProductReading, :ProductReadingTask, :ProductTripleMixing, :PurchaseItem, :SaleCreditItem, :SaleItem, :User, :Version])
