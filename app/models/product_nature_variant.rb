...
class ProductNatureVariant < Ekylibre::Record::Base
  ...
  delegate :depreciable?, :depreciation_rate, :deliverable?, :purchasable?, :saleable?, :subscribing?, :financial_asset_account, :financial_asset_depreciations_account, :financial_asset_depreciations_inputations_expenses_account, :product_account, :charge_account, :stock_account, to: :category
