...
class ProductNatureVariant < Ekylibre::Record::Base
  ...
  delegate :depreciable?, :depreciation_rate, :deliverable?, :purchasable?, :saleable?, :subscribing?, :financial_asset_account, :financial_asset_allocation_account, :financial_asset_expenses_account, :product_account, :charge_account, :stock_account, to: :category
