...
class Plant < Bioproduct
  attr_accessible :current_place_id, :unit, :variety, :nature_id, :reproductor, :external, :born_at, :dead_at, :description, :description, :identification_number, :name, :picture, :work_number
