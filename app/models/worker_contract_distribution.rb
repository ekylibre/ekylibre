...
#
# == Table: worker_contract_distributions
#
...
#  main_activity_id       :integer(4)       not null
#  updated_at             :datetime         not null
#  updater_id             :integer(4)
#  worker_contract_id     :integer(4)       not null
#
class WorkerContractDistribution < ApplicationRecord
  belongs_to :worker_contract, inverse_of: :distributions
