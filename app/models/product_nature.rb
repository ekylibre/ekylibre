...
class ProductNature < Ekylibre::Record::Base
  ...
  validates_length_of :derivative_of, :name, :number, :picture_content_type, :picture_file_name, :population_counting, :reference_name, :variety, allow_nil: true, maximum: 255
