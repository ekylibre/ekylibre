...
class SaleDelivery < ActiveRecord::Base
  belongs_to :company 
  belongs_to :contact
  belongs_to :invoice
  belongs_to :mode, :class_name=>SaleDeliveryMode.name
  belongs_to :order, :class_name=>SaleOrder.name
  belongs_to :transport
  has_many :lines, :class_name=>SaleDeliveryLine.name, :foreign_key=>:delivery_id, :dependent=>:destroy
