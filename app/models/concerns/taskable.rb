module Taskable
  ...
  included do
    ...
    has_many :product_quadruple_mixings, as: :originator, dependent: :destroy
    has_many :product_quintuple_mixings, as: :originator, dependent: :destroy
    has_many :product_reading_tasks,     as: :originator, dependent: :destroy
    has_many :product_triple_mixings,    as: :originator, dependent: :destroy
