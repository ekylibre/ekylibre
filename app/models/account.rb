...
class Account < Ekylibre::Record::Base
  ...
  # has_many :financial_assets_depreciations, class_name: "ProductNatureCategory", foreign_key: :financial_asset_allocation_account_id
  # has_many :financial_asset_depreciations_inputations_expenses_categories, class_name: "ProductNatureCategory", foreign_key: :financial_asset_expenses_account_id
