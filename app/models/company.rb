...
class Company < ActiveRecord::Base
  ...
  def after_create
   ...
   # self.units.create(:name=>'g',  :fullname=>'Grammes')
   # self.units.create(:name=>'kg', :fullname=>'Kilogrammes')
   # self.units.create(:name=>'m',  :fullname=>'Mètres')
   # self.units.create(:name=>'km', :fullname=>'Kilomètres')
   # self.units.create(:name=>'m²', :fullname=>'Mètres carré')
   # self.units.create(:name=>'ha', :fullname=>'Hectares')
   # self.units.create(:name=>'m³', :fullname=>'Mètres cube')
...
#    self.taxes.create(:name=>'TVA 19.6', :nature=>'percent')
   ...
   # self.currencies.create!(:name=>'euro', :code=>'E', :format=>'eu', :rate=>6.53)
    ...
    menu_item3 = menu.menu_items.create!(:name=>'Gestion', :url=>'/management', :company_id => self.id )
