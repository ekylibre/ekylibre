...
class Issue < Ekylibre::Record::Base
  ...
  scope :of_campaign, lambda { |campaign|
    where(target_id: Product.where(activity_production_id: ActivityProduction.of_campaign(campaign).pluck(:id)))
  }

  scope :of_activity, lambda { |activity|
    where(target_id: Product.where(activity_production_id: activity.productions.pluck(:id)))
  }
