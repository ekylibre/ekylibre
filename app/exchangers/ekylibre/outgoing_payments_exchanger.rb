  ...
  def import
    ...
    rows.each_with_index do |row, index|
      ...
      unless payment_mode = OutgoingPaymentMode.where(name: r.outgoing_payment_mode_name).first
        raise ActiveExchanger::InvalidDataError, "Cannot find outgoing payment mode #{r.outgoing_payment_mode_name} at line #{line_index}"
      end
      ...
      if payment_mode and r.amount and paid_at and entity and responsible
