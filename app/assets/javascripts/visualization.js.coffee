...
(($) ->
  ...
  $.widget "ui.visualization",
    ...
    back: (backgrounds) ->
      return this.options.backgrounds unless backgrounds?
      this.options.backgrounds.add backgrounds
      this._refreshBackgroundLayer()
    ...
    #tilelegend: (tilelegend) ->
      #return this.map.getTileLegend() unless tilelegend?
      #this.options.view.tilelegend = tilelegend
      #this._refreshTileLegend()
    ...
    _refreshBackgroundLayer: ->
      ...
      if this.options.backgrounds?
        ...
        if this.options.backgrounds.name is "String"
          this.backgroundLayer = L.tileLayer.provider(this.options.backgrounds.name)
          this.backgroundLayer.addTo this.map
        else
          console.log "How to set background with #{this.options.backgrounds.name}?"
          console.log this.options.backgrounds.name
      this
    ...
    _refreshControls: ->
      ...
      unless this.options.controls.scale is false
        this.controls.scale = new L.Control.Scale(this.options.controls.scale)
        this.map.addControl this.controls.scale
      #unless this.options.controls.tilelegend is false
        #this.controls.tilelegend = new L.Control.TileLegends(this.options.controls.tilelegends)
        #this.map.addControl this.controls.tilelegend
