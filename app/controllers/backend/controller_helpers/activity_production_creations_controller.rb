    ...
    class ActivityProductionCreationsController < Backend::BaseController
      ...
      def create
        ...
        if creation_helper.valid?
          head :created, location: new_backend_activity_production_path(campaign_id: creation_helper.campaign, activity_id: creation_helper.activity, cultivable_zone_id: creation_helper.cultivable_zone)
        else
