    ...
    class LandParcelsVisualizationsController < Backend::VisualizationsController
      ...
      def show
        main_serie = LandParcel.supports_of_campaign(current_campaign).find_each.map do |p|
          ...
          available_indicators.each do |indicator|
            ...
            if indicator == :soil_nature
              soil_nature = Onoma::SoilNature[p.soil_nature]
            ...
            popup_content << {
              label: Onoma::Indicator[indicator].human_name,
        ...
        config = view_context.configure_visualization do |v|
          ...
          v.bubbles :available_water_capacity_per_area, :main, label: Onoma::Indicator[:available_water_capacity_per_area].human_name
          v.choropleth :organic_matter_concentration, :main, hidden: true, label: Onoma::Indicator[:organic_matter_concentration].human_name
          v.choropleth :potential_hydrogen, :main, hidden: true, label: Onoma::Indicator[:potential_hydrogen].human_name
