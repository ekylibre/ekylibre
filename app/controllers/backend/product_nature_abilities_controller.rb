class Backend::ProductNatureAbilitiesController < BackendController
  manage_restfully
  ...
  def index
    respond_to do |format|
      format.html
      format.xml  { render :xml => ProductNatureAbility.all }
      format.json { render :json => ProductNatureAbility.all }
    end
  end
