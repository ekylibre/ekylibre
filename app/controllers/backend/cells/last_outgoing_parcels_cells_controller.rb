class Backend::Cells::LastOutgoingParcelsCellsController < Backend::Cells::BaseController
  list(model: :parcels, conditions: { nature: 'outgoing' }, order: 'given_at DESC', per_page: 5) do |t|
