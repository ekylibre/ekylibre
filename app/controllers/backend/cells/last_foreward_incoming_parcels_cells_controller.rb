module Backend
  module Cells
    class LastForewardIncomingParcelsCellsController < Backend::Cells::BaseController
      list(model: :receptions, conditions: { nature: 'incoming', state: %w[draft] }, order: 'given_at DESC', per_page: 5) do |t|
        ...
        t.column :purchase_order, url: { controller: '/backend/purchase_orders' }, hidden: true
      end
