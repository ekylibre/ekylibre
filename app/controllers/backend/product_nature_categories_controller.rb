...
module Backend
  class ProductNatureCategoriesController < Backend::BaseController
    ...
    def update
      ...
      return if save_and_redirect(@product_nature_category, url: local_redirect_target(params[:redirect]) || { action: :show, id: 'id'.c }, notify: (local_redirect_target(params[:redirect]) ? :record_x_updated : false), identifier: :name)
