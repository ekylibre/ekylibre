class Pasteque::V5::CashesController < Pasteque::V5::BaseController
  ...
  manage_restfully only: [:show, :update, :search], model: :cash_session, get_filters: {id: :id, cashRegisterId: :cash_id}, update_filters: update_filters, search_filters: search_filters
