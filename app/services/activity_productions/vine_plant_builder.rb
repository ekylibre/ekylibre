...
module ActivityProductions
  ...
  class VinePlantBuilder
    ...
    def create_vine_plant_from_production
      ...
      vine_variety = RegisteredVineVariety.find_by(short_name: 'Abondant B')

      plant_name = @activity_production.custom_name + " | #{vine_variety.short_name}"
      ...
      plant.read!(:certification_label, 'Pomerol', at: start_at)
