...
*   Then, install all dependencies. Command and package can differ between
    distributions or OS:
        brew install zlib qt icu4c postgresql postgis yarn xpdf imagemagick graphicsmagick ghostscript tesseract
        brew link xpdf
        gem install charlock_holmes -- --with-icu-dir=/usr/local/opt/icu4c
        # brew install pdftk libreoffice poppler-utils poppler-data openjdk-7-jdk redis-server libcurl4-openssl-dev libgeos-dev libgeos++-dev libproj-dev libpq-dev libxml2-dev libxslt1-dev zlib1g-dev libqtwebkit-dev
