...
or create .bash_profile in your home directory and add the following lines according to your JAVA installation path
...
* Optionally, it's possible to load anonymized data of a real (french polycultural-cattling) farm, just replace instance by _demo_:
