...
**Effort restant : ~7 j·h** (85 → 72 après les arbitrages ; A.1, A.3, A.5, A.6 et A.7a faits, A.8 quasi terminé). Reste A.7b (remplacement d'`active_list`, bloqué par ADR-6.3, chiffré au lot G) et le plancher SimpleCov. **`ekylibre-planning` est porté** — le couplage annoncé n'existait pas : voir [l'audit §3.4](v6-dependency-audit.md). **Dépendances : aucune — démarre immédiatement, en parallèle de P0.**
