...
{:.alert .alert-warning}
Pour utiliser le service de météorologie 'Openweathermap', vous devez préalablement vous [**créer un compte et récupérer une clef d'API**](https://ekylibre.github.io/doc/fr/chapitre10/#connexions){:target="_blank"}.
