# Bienvenue dans l'aide d'Ekylibre 
...
## Le tableau de bord  
Configuré par défaut pour chaque module et [personnalisable](https://ekylibre.github.io/doc/fr/chapitre4/#perso){:target="_blank"} grâce à différents indicateurs, il vous permet, en un coup d'œil, de visualiser des informations générales ou ciblées pouvant nécessiter une action de votre part.
