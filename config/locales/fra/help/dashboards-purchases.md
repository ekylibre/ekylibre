...
Il est conseillé d'avoir enregistré dans un premier temps vos fournisseurs grâce au module [**Tiers**](/backend/dashboards/relationship). La création d'**articles**, le paramétrage d'un ou de plusieurs [**types d'achat**](https://ekylibre.github.io/doc/fr/chapitre6/#types){:target="_blank"} et une personnalisation des documents avec votre **logo** peuvent également être configurés selon vos besoins, dans le module [**Configuration**](/backend/dashboards/settings).
...
Cliquez sur **"Commandes"** pour afficher la liste des [**commandes**](https://ekylibre.github.io/doc/fr/chapitre6/#achats){:target="_blank"} enregistrées dans l'application et vous permettre d'en créer de nouvelles.

Cliquez sur **"Factures"** pour afficher la liste des [**factures**](https://ekylibre.github.io/doc/fr/chapitre6/#facturation){:target="_blank"} enregistrées dans l'application et vous permettre d'en créer de nouvelles. Une facture peut également être générée depuis une réception avec un rapprochement automatique.
...
Cliquez sur **"Décaissements"** pour accéder à la liste des [**décaissements**](https://ekylibre.github.io/doc/fr/chapitre6/#decaissements){:target="_blank"} enregistrés dans l'application et vous permettre d'en créer de nouveaux. Un décaissement peut, plus facilement, être renseigné depuis la vue d'une facture.

Cliquez sur **"Lots de décaissements"** pour accéder à la liste des [**lots de décaissements**](https://ekylibre.github.io/doc/fr/chapitre6/#lots){:target="_blank"} enregistrés dans l'application et vous permettre d'en créer de nouveaux. Ils permettent de réaliser plusieurs règlements en une seule opération ainsi que la génération de lettres-chèques.
