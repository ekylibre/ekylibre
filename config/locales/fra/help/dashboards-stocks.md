...
* En fonction de vos préférences, activez ou non le mode [**stock permanent**](https://ekylibre.github.io/doc/fr/chapitre5/#societe){:target="_blank"}, mais notez qu'une fois ce mode activé, une écriture est générée à chaque mouvement de stock&nbsp;;
* Renseignez le stock initial de l'exploitation sans générer d'écritures comptables en enregistrant les [**matières**](https://ekylibre.github.io/doc/fr/chapitre8/#nelle-matiere){:target="_blank"} déjà approvisionnées ou récoltées, afin de saisir les premières opérations (achats, ventes, interventions, etc.) avec les quantités réelles disponibles&nbsp;;
* Ajoutez, le cas échéant, les différentes [**zones de stockage**](https://ekylibre.github.io/doc/fr/chapitre6/#stockage){:target="_blank"} qui sont requises pour réaliser les réceptions de marchandises si elles n'ont pas été préalablement définies dans l'assistant de démarrage.
...
Cliquez sur **"Matières"** pour afficher la liste des [**matières**](https://ekylibre.github.io/doc/fr/chapitre8/#nelle-matiere){:target="_blank"} et vous permettre d'en créer de nouvelles. Cette fonctionnalité nécessite d'avoir, avec le module [**Configuration**](/backend/dashboards/settings), préalablement importé ou créé les articles stockables que vous utilisez ou produisez sur votre exploitation.

Cliquez sur **"Inventaires"** pour afficher la liste des [**inventaires**](https://ekylibre.github.io/doc/fr/chapitre8/#nel-inventaire){:target="_blank"} et vous permettre d'en créer de nouveaux.

Cliquez sur **"Zones de stockage"** pour afficher la liste des [**zones de stockage**](https://ekylibre.github.io/doc/fr/chapitre6/#stockage){:target="_blank"} et vous permettre d'en créer de nouvelles. Elles sont requises pour réaliser les réceptions de marchandises et visualiser les produits contenus dans chacune d'entre elles.
...
Cliquez sur **"Réceptions"** pour afficher la liste des [**réceptions**](https://ekylibre.github.io/doc/fr/chapitre8/#recept-stocks){:target="_blank"} et vous permettre d'en enregistrer de nouvelles. Les réceptions peuvent être rapprochées avec des commandes enregistrées via le module [**Achats**](/backend/dashboards/purchases) (offres Gestion et Performance uniquement).

**[Expéditions]**

Cliquez sur **"Expéditions"** pour afficher la liste des [**expéditions**](https://ekylibre.github.io/doc/fr/chapitre8/#nelle-expedition){:target="_blank"} et vous permettre d'en créer de nouvelles.

**[Livraisons]**

Cliquez sur **"Livraisons"** pour afficher la liste des [**livraisons**](https://ekylibre.github.io/doc/fr/chapitre8/#livraison){:target="_blank"} et vous permettre d'en paramétrer de nouvelles.
