...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical, tag: 'div', class: 'control-group vertical', error_class: 'error' do |b|
    b.use :html5
    b.use :placeholder
    b.use :label
    b.wrapper tag: 'div', class: 'controls' do |ba|
  ...
  config.wrappers :nested_append, tag: 'span', class: 'control-group', error_class: 'error' do |b|
    b.use :html5
    b.use :placeholder
    b.wrapper tag: 'span', class: 'input-append' do |append|
      append.use :input
    end
    b.use :error, wrap_with: { tag: 'span', class: 'help-inline' }
    b.use :hint,  wrap_with: { tag: 'p', class: 'help-block' }
