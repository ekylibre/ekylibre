...
unless ENV['CRON'] && ENV['CRON'].to_i.zero?
  ...
  Sidekiq::Cron::Job.create(name: 'Check on equipments and alerts if they near the end of their lives - every day', cron: '1 */7 * * *', klass: 'EquipmentLifeProgressCheckJob')
end
