class MergeSalesInvoicesIntoOrders < ActiveRecord::Migration
  ...
  def self.up
    ...
    create_table(:deletable_stock_moves, :force=>true, :id=>false) do |t|
      t.column(:id, :integer)
    end
    ...
    create_table(:deletable_sales_orders, :force=>true, :id=>false) do |t|
      t.column(:id, :integer)
    end
