...
ActiveRecord::Base.transaction do
  ...
  sale_price_list = ProductPriceListing.create!(:name => I18n.t('models.company.default.category'),:by_default => true,:code => "12345678" )
  firm = Entity.create!(:sale_price_listing_id => sale_price_list.id, :nature_id => undefined_nature.id, :language => language, :last_name => company, :currency => currency, :of_company => true)
