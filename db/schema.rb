...
ActiveRecord::Schema.define(:version => 20080819191919) do
  ...
  create_table "reports", :force => true do |t|
    ...
    t.string   "template_md5",                 :null => false
    t.integer  "key"
  ...
  add_index "reports", ["sha256"], :name => "index_reports_on_sha256", :unique => true
  add_index "reports", ["updated_at"], :name => "index_reports_on_updated_at"
  add_index "reports", ["updated_by"], :name => "index_reports_on_updated_by"
  ...
  add_foreign_key "reports", ["company_id"], "companies", ["id"], :name => "reports_company_id_fkey"
  add_foreign_key "reports", ["created_by"], "users", ["id"], :on_update => :cascade, :on_delete => :restrict, :name => "reports_created_by_fkey"
  add_foreign_key "reports", ["updated_by"], "users", ["id"], :on_update => :cascade, :on_delete => :restrict, :name => "reports_updated_by_fkey"
