...
ActiveRecord::Schema.define(version: 20160510130247) do
  ...
  add_index "bank_statement_items", ["transaction_id"], name: "index_bank_statement_items_on_transaction_id", using: :btree
