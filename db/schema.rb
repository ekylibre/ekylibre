...
ActiveRecord::Schema.define(:version => 20080819191919) do
  ...
  create_table "companies", :force => true do |t|
    ...
    t.string   "siren",        :limit => 9, :default => "000000000", :null => false
  ...
  create_table "users", :force => true do |t|
    ...
    t.boolean  "locked",                        :default => false, :null => false
    t.boolean  "deleted",                       :default => false, :null => false
    t.integer  "connected_at",                  :default => 0,     :null => false
    t.string   "email"
    t.integer  "company_id",                                       :null => false
    t.integer  "language_id",                                      :null => false
    t.integer  "role_id",                                          :null => false
  ...
  add_foreign_key "actions", ["created_by"], "users", ["id"], :on_update => :cascade, :on_delete => :restrict, :name => "actions_created_by_fkey"
  add_foreign_key "actions", ["updated_by"], "users", ["id"], :on_update => :cascade, :on_delete => :restrict, :name => "actions_updated_by_fkey"

  add_foreign_key "actions_roles", ["action_id"], "actions", ["id"], :name => "actions_roles_action_id_fkey"
  add_foreign_key "actions_roles", ["role_id"], "roles", ["id"], :name => "actions_roles_role_id_fkey"
  add_foreign_key "actions_roles", ["created_by"], "users", ["id"], :on_update => :cascade, :on_delete => :restrict, :name => "actions_roles_created_by_fkey"
  add_foreign_key "actions_roles", ["updated_by"], "users", ["id"], :on_update => :cascade, :on_delete => :restrict, :name => "actions_roles_updated_by_fkey"
