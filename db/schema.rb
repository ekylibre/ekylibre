...
ActiveRecord::Schema.define(version: 20150908214101) do
  ...
  add_index "outgoing_deliveries", ["responsible_id"], name: "index_outgoing_deliveries_on_responsible_id", using: :btree
  add_index "outgoing_deliveries", ["transporter_id"], name: "index_outgoing_deliveries_on_transporter_id", using: :btree
  add_index "outgoing_deliveries", ["transporter_purchase_id"], name: "index_outgoing_deliveries_on_transporter_purchase_id", using: :btree
