...
ActiveRecord::Schema.define(:version => 20100118091000) do
  ...
  create_table "delivery_lines", :force => true do |t|
    ...
    t.decimal  "quantity",          :precision => 16, :scale => 2, :default => 1.0, :null => false
  ...
  create_table "inventory_lines", :force => true do |t|
    ...
    t.decimal  "theoric_quantity",   :precision => 16, :scale => 2,                :null => false
    t.decimal  "validated_quantity", :precision => 16, :scale => 2,                :null => false
  ...
  create_table "payments", :force => true do |t|
    ...
    t.integer  "entity_id"
    t.date     "to_bank_on",                                    :default => '2014-01-10', :null => false
  ...
  create_table "prices", :force => true do |t|
    ...
    t.decimal  "quantity_min",      :precision => 16, :scale => 2, :default => 0.0,   :null => false
    t.decimal  "quantity_max",      :precision => 16, :scale => 2, :default => 0.0,   :null => false
    t.integer  "product_id",                                                          :null => false
    t.integer  "tax_id",                                                              :null => false
    t.integer  "company_id",                                                          :null => false
    t.datetime "created_at",                                                          :null => false
  ...
  create_table "products", :force => true do |t|
    ...
    t.decimal  "quantity_min",                         :precision => 16, :scale => 2, :default => 0.0
    t.decimal  "critic_quantity_min",                  :precision => 16, :scale => 2, :default => 1.0
    t.decimal  "quantity_max",                         :precision => 16, :scale => 2, :default => 0.0
  ...
  add_index "stock_locations", ["company_id"], :name => "index_stock_locations_on_company_id"
  add_index "stock_locations", ["created_at"], :name => "index_stock_locations_on_created_at"
  add_index "stock_locations", ["creator_id"], :name => "index_stock_locations_on_creator_id"
  add_index "stock_locations", ["updated_at"], :name => "index_stock_locations_on_updated_at"
  add_index "stock_locations", ["updater_id"], :name => "index_stock_locations_on_updater_id"
  ...
  create_table "stocks", :force => true do |t|
    t.integer  "product_id",                                                               :null => false
    t.integer  "location_id",                                                              :null => false
    t.decimal  "current_real_quantity",    :precision => 16, :scale => 2, :default => 0.0, :null => false
    t.decimal  "current_virtual_quantity", :precision => 16, :scale => 2, :default => 0.0, :null => false
    t.decimal  "quantity_min",             :precision => 16, :scale => 2, :default => 1.0, :null => false
    t.decimal  "critic_quantity_min",      :precision => 16, :scale => 2, :default => 0.0, :null => false
    t.decimal  "quantity_max",             :precision => 16, :scale => 2, :default => 0.0, :null => false
    t.integer  "company_id",                                                               :null => false
    t.datetime "created_at",                                                               :null => false
    t.datetime "updated_at",                                                               :null => false
