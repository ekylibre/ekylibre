...
--
-- Name: registered_agroedi_crops; Type: TABLE; Schema: lexicon; Owner: -
--
...
--
-- Name: registered_area_items; Type: TABLE; Schema: lexicon; Owner: -
--
...
--
-- Name: registered_hourly_weathers; Type: TABLE; Schema: lexicon; Owner: -
--
...
--
-- Name: registered_natural_zones; Type: TABLE; Schema: lexicon; Owner: -
--
...
--
-- Name: registered_weather_stations; Type: TABLE; Schema: lexicon; Owner: -
--
...
--
-- Name: incoming_harvest_crops; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.incoming_harvest_crops (
    id bigint NOT NULL,
    incoming_harvest_id bigint NOT NULL,
    ...
    updater_id bigint,
    lock_version integer DEFAULT 0 NOT NULL,
    harvest_intervention_id bigint
);


--
-- Name: incoming_harvest_crops_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.incoming_harvest_crops_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: incoming_harvest_crops_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.incoming_harvest_crops_id_seq OWNED BY public.incoming_harvest_crops.id;
...
CREATE TABLE public.product_nature_category_taxations (
    id integer NOT NULL,
    product_nature_category_id integer CONSTRAINT product_nature_category_tax_product_nature_category_id_not_null NOT NULL,
    tax_id integer NOT NULL,
    usage character varying NOT NULL,
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
...
CREATE TABLE public.product_nature_variant_components (
    id integer NOT NULL,
    product_nature_variant_id integer CONSTRAINT product_nature_variant_compo_product_nature_variant_id_not_null NOT NULL,
...
--
-- Name: ride_set_equipments; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.ride_set_equipments (
    id bigint NOT NULL,
    ride_set_id bigint,
    product_id bigint,
    nature character varying,
...
--
-- Name: ride_set_equipments_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.ride_set_equipments_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: ride_set_equipments_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.ride_set_equipments_id_seq OWNED BY public.ride_set_equipments.id;
...
CREATE TABLE public.wine_incoming_harvest_storages (
    id integer NOT NULL,
    wine_incoming_harvest_id integer CONSTRAINT wine_incoming_harvest_storage_wine_incoming_harvest_id_not_null NOT NULL,
    storage_id integer NOT NULL,
    quantity_value numeric(19,4) NOT NULL,
    quantity_unit character varying NOT NULL,
    created_at timestamp without time zone NOT NULL,
...
CREATE MATERIALIZED VIEW public.worker_time_indicators AS
 SELECT worker_id,
    ...
    max(stopped_at) AS stop_at,
    (max(stopped_at) - min(started_at)) AS duration
  ...
  ORDER BY worker_id, (min(started_at))
  WITH NO DATA;
...
--
-- Name: incoming_harvest_crops id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.incoming_harvest_crops ALTER COLUMN id SET DEFAULT nextval('public.incoming_harvest_crops_id_seq'::regclass);
...
--
-- Name: ride_set_equipments id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ride_set_equipments ALTER COLUMN id SET DEFAULT nextval('public.ride_set_equipments_id_seq'::regclass);
...
--
-- Name: incoming_harvest_indicators; Type: MATERIALIZED VIEW; Schema: public; Owner: -
--

CREATE MATERIALIZED VIEW public.incoming_harvest_indicators AS
 SELECT ca.id AS campaign_id,
   ...
   FROM (((((public.incoming_harvest_crops ihc
     JOIN public.incoming_harvests ih ON ((ih.id = ihc.incoming_harvest_id)))
     JOIN public.products pr ON ((ihc.crop_id = pr.id)))
     JOIN public.activity_productions ap ON ((pr.activity_production_id = ap.id)))
     JOIN public.campaigns ca ON ((ap.campaign_id = ca.id)))
     JOIN public.activities act ON ((ap.activity_id = act.id)))
...
ALTER TABLE ONLY lexicon.registered_area_items
    ADD CONSTRAINT registered_area_items_pkey PRIMARY KEY (id);
...
--
-- Name: registered_weather_stations registered_weather_stations_pkey; Type: CONSTRAINT; Schema: lexicon; Owner: -
--

ALTER TABLE ONLY lexicon.registered_weather_stations
    ADD CONSTRAINT registered_weather_stations_pkey PRIMARY KEY (reference_name);
...
--
-- Name: incoming_harvest_crops incoming_harvest_crops_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.incoming_harvest_crops
    ADD CONSTRAINT incoming_harvest_crops_pkey PRIMARY KEY (id);
...
--
-- Name: ride_set_equipments ride_set_equipments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ride_set_equipments
    ADD CONSTRAINT ride_set_equipments_pkey PRIMARY KEY (id);
...
--
-- Name: registered_area_items_id; Type: INDEX; Schema: lexicon; Owner: -
--
...
--
-- Name: registered_cadastral_buildings_reference_name; Type: INDEX; Schema: lexicon; Owner: -
--
...
--
-- Name: registered_graphic_parcels_id; Type: INDEX; Schema: lexicon; Owner: -
--
...
--
-- Name: registered_hourly_weathers_average_temp; Type: INDEX; Schema: lexicon; Owner: -
--
...
--
-- Name: registered_hourly_weathers_max_wind_speed; Type: INDEX; Schema: lexicon; Owner: -
--
...
--
-- Name: registered_hourly_weathers_pressure; Type: INDEX; Schema: lexicon; Owner: -
--
...
--
-- Name: registered_hourly_weathers_rain; Type: INDEX; Schema: lexicon; Owner: -
--
...
--
-- Name: registered_hourly_weathers_started_at; Type: INDEX; Schema: lexicon; Owner: -
--
...
--
-- Name: registered_hourly_weathers_station_id; Type: INDEX; Schema: lexicon; Owner: -
--
...
--
-- Name: registered_natural_zones_nature; Type: INDEX; Schema: lexicon; Owner: -
--
...
--
-- Name: registered_weather_stations_country; Type: INDEX; Schema: lexicon; Owner: -
--
...
--
-- Name: registered_weather_stations_country_zone; Type: INDEX; Schema: lexicon; Owner: -
--
...
--
-- Name: registered_weather_stations_reference_name; Type: INDEX; Schema: lexicon; Owner: -
--
...
--
-- Name: index_analyses_on_cultivable_zone_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_analyses_on_cultivable_zone_id ON public.analyses USING btree (cultivable_zone_id);
...
--
-- Name: index_catalog_items_on_product_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_catalog_items_on_product_id ON public.catalog_items USING btree (product_id);
...
--
-- Name: index_entities_on_client_payment_mode_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_entities_on_client_payment_mode_id ON public.entities USING btree (client_payment_mode_id);
...
--
-- Name: index_entities_on_payslip_contributor_account_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_entities_on_payslip_contributor_account_id ON public.entities USING btree (payslip_contributor_account_id);
...
--
-- Name: index_incoming_harvest_crops_on_created_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_incoming_harvest_crops_on_created_at ON public.incoming_harvest_crops USING btree (created_at);


--
-- Name: index_incoming_harvest_crops_on_creator_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_incoming_harvest_crops_on_creator_id ON public.incoming_harvest_crops USING btree (creator_id);


--
-- Name: index_incoming_harvest_crops_on_crop_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_incoming_harvest_crops_on_crop_id ON public.incoming_harvest_crops USING btree (crop_id);


--
-- Name: index_incoming_harvest_crops_on_harvest_intervention_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_incoming_harvest_crops_on_harvest_intervention_id ON public.incoming_harvest_crops USING btree (harvest_intervention_id);


--
-- Name: index_incoming_harvest_crops_on_incoming_harvest_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_incoming_harvest_crops_on_incoming_harvest_id ON public.incoming_harvest_crops USING btree (incoming_harvest_id);


--
-- Name: index_incoming_harvest_crops_on_updated_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_incoming_harvest_crops_on_updated_at ON public.incoming_harvest_crops USING btree (updated_at);


--
-- Name: index_incoming_harvest_crops_on_updater_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_incoming_harvest_crops_on_updater_id ON public.incoming_harvest_crops USING btree (updater_id);


--
-- Name: index_incoming_harvest_indicators_on_activity_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_incoming_harvest_indicators_on_activity_id ON public.incoming_harvest_indicators USING btree (activity_id);


--
-- Name: index_incoming_harvest_indicators_on_activity_production_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_incoming_harvest_indicators_on_activity_production_id ON public.incoming_harvest_indicators USING btree (activity_production_id);


--
-- Name: index_incoming_harvest_indicators_on_campaign_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_incoming_harvest_indicators_on_campaign_id ON public.incoming_harvest_indicators USING btree (campaign_id);


--
-- Name: index_incoming_harvest_indicators_on_crop_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_incoming_harvest_indicators_on_crop_id ON public.incoming_harvest_indicators USING btree (crop_id);
...
--
-- Name: index_incoming_harvest_storages_on_product_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_incoming_harvest_storages_on_product_id ON public.incoming_harvest_storages USING btree (product_id);
...
--
-- Name: index_incoming_harvests_on_driver_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_incoming_harvests_on_driver_id ON public.incoming_harvests USING btree (driver_id);


--
-- Name: index_incoming_harvests_on_intervention_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_incoming_harvests_on_intervention_id ON public.incoming_harvests USING btree (intervention_id);
...
--
-- Name: index_incoming_harvests_on_tractor_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_incoming_harvests_on_tractor_id ON public.incoming_harvests USING btree (tractor_id);


--
-- Name: index_incoming_harvests_on_trailer_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_incoming_harvests_on_trailer_id ON public.incoming_harvests USING btree (trailer_id);
...
--
-- Name: index_ride_set_equipments_on_created_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_ride_set_equipments_on_created_at ON public.ride_set_equipments USING btree (created_at);


--
-- Name: index_ride_set_equipments_on_creator_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_ride_set_equipments_on_creator_id ON public.ride_set_equipments USING btree (creator_id);


--
-- Name: index_ride_set_equipments_on_product_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_ride_set_equipments_on_product_id ON public.ride_set_equipments USING btree (product_id);


--
-- Name: index_ride_set_equipments_on_ride_set_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_ride_set_equipments_on_ride_set_id ON public.ride_set_equipments USING btree (ride_set_id);


--
-- Name: index_ride_set_equipments_on_updated_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_ride_set_equipments_on_updated_at ON public.ride_set_equipments USING btree (updated_at);


--
-- Name: index_ride_set_equipments_on_updater_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_ride_set_equipments_on_updater_id ON public.ride_set_equipments USING btree (updater_id);
...
--
-- Name: ride_set_equipments fk_rails_14d0649037; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ride_set_equipments
    ADD CONSTRAINT fk_rails_14d0649037 FOREIGN KEY (ride_set_id) REFERENCES public.ride_sets(id);
...
--
-- Name: analyses fk_rails_226357896d; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.analyses
    ADD CONSTRAINT fk_rails_226357896d FOREIGN KEY (cultivable_zone_id) REFERENCES public.cultivable_zones(id);
...
--
-- Name: ride_set_equipments fk_rails_38d40f03b1; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: catalog_items fk_rails_9a8920d164; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: entities fk_rails_b7534d0f33; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.entities
    ADD CONSTRAINT fk_rails_b7534d0f33 FOREIGN KEY (client_payment_mode_id) REFERENCES public.incoming_payment_modes(id);
...
--
-- Name: incoming_harvest_crops fk_rails_d5e363f8bc; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.incoming_harvest_crops
    ADD CONSTRAINT fk_rails_d5e363f8bc FOREIGN KEY (incoming_harvest_id) REFERENCES public.incoming_harvests(id);
